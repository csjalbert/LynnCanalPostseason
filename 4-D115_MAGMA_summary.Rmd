...
wd <-
  "V:/Analysis/1_SEAK/Sockeye/Mixture/Lynn Canal Postseason/2019/MAGMA/"
...
save.image("V:/Analysis/1_SEAK/Sockeye/Mixture/Lynn Canal Postseason/2019/MAGMA/output/D115summary40K.RData")
```
...
All looks good, none of the GR stats are greater than 1.2, so were in pretty good shape!
...
```{r age_import}
LYNN.ages <- read_tsv("output/magma_summariesAgesGroups.txt") # import the table containing ages
```
...
D115.ages <- LYNN.ages %>%
  ...
  arrange(Age, ReportingGroup) # sort by age, first then reporting groups.
```
