...
```{r create_dirs}
dir.create(file.path("../2019//", "MAGMA")) # create MAGMA directory. 

dir.create(file.path("../2019//MAGMA", "analysis")) # create analysis subdir. 

dir.create(file.path("../2019//MAGMA", "data")) # create data subdir. 

dir.create(file.path("../2019//MAGMA", "output")) # create output subdir. 
```
...
```{r prepdata}
metadata <-
  read_csv(file = "../2019/Detailed ASL Samples_011519.csv")
...
```{r metadata_export}
write_tsv(x = MAGMA_meta, path = "../2019/MAGMA/data/metadata.txt", na = "NA", append = FALSE, col_names = TRUE, quote_escape = "double")
```
...
```{r harvest_export}
write_tsv(x = MAGMA_harv, path = "../2019/MAGMA/data/harvest.txt", na = "NA", append = FALSE, col_names = TRUE, quote_escape = "double")
```
...
```{r export_txt}
write_tsv(x = group_names, path = "../2019/MAGMA/data/group_names.txt", na = "NA", append = FALSE, col_names = TRUE, quote_escape = "double") # export object group_names

write_tsv(x = groups, path = "../2019/MAGMA/data/groups.txt", na = "NA", append = FALSE, col_names = TRUE, quote_escape = "double")
```
