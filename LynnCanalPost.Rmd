...
group_names <-
  unique(groups4_pops239$GROUPS) # find all unique groups, should be 4...
...
```{r export_txt}
dput(x = group_names, file = "../2018/MAGMA/data/group_names.txt") # export object group_names

write_tsv(x = groups, path = "../2018/MAGMA/data/groups.txt", na = "NA", append = FALSE, col_names = TRUE)
```

 # Note that I manually added the last few groups to the groups.txt file. xxx work out what exactly they are and if they are necessary...
BURN	1
MAIN	1
SPEE	1
SWEE	1
